...
public class Plugin
{
  ...
  protected final String TEXT_9 = " generator plugin." + NL + " * <!-- begin-user-doc -->" + NL + " * <!-- end-user-doc -->" + NL + " * @generated" + NL + " */" + NL + "public final class ";
 ...
 */
    ...
    GenModel2 genModel = (GenModel2)argument; /* Trick to import java.util.* without warnings */Iterator.class.getName();
    ...
    stringBuffer.append(genModel.getGeneratorPluginClassName());
    ...
    for (String pluginClassName : genModel.getGeneratorResourceDelegateImportedPluginClassNames()) {
    ...
    stringBuffer.append(genModel.getImportedName(genModel.getQualifiedGeneratorPluginClassName() + "Properties"));
    ...
    if (genPackage.getGenModel() == genModel || !(genPackage instanceof GenModel2 && ((GenModel2)genPackage.getGenModel()).hasGeneratorSupport())) { 
    ...
    stringBuffer.append(genModel.getImportedName(genModel.getQualifiedGeneratorPluginClassName() + "Images"));
