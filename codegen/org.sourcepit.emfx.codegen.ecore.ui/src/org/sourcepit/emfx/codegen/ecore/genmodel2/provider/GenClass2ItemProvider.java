...
import org.eclipse.emf.codegen.ecore.genmodel.provider.GenClassItemProvider;
...
/**
 * This is the item provider adapter for a {@link org.sourcepit.emfx.codegen.ecore.genmodel2.GenClass2} object. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class GenClass2ItemProvider extends GenClassItemProvider
   implements
      ...
      IItemPropertySource
{
    ...
    * @generated
    */
   public GenClass2ItemProvider(AdapterFactory adapterFactory)
   {
   ...
   /**
    * This returns GenClass2.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
    * 
    * @generated NOT
    */
   @Override
   ...
   public void notifyChanged(Notification notification)
   {
      ...
      switch (notification.getFeatureID(GenClass2.class))
      {
