 ...
 */
    ...
    Iterator<String> packagesIterator = genModel.getGeneratorQualifiedPackageNames().iterator(); if (packagesIterator.hasNext()) { String pack = packagesIterator.next();
    ...
    Iterator<String> requiredPluginIterator = genModel.getGeneratorRequiredPlugins().iterator(); if (requiredPluginIterator.hasNext()) { String pluginID = requiredPluginIterator.next();
