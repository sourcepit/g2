...
public class Plugin
{
  ...
  protected final String TEXT_9 = " editor plugin." + NL + " * <!-- begin-user-doc -->" + NL + " * <!-- end-user-doc -->" + NL + " * @generated" + NL + " */" + NL + "public final class ";
 ...
 */
    ...
    stringBuffer.append(genModel.getGeneratorUIPluginPackageName());
    ...
    stringBuffer.append(genModel.getGeneratorUIPluginClassName());
